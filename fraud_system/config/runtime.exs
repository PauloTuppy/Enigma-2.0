...
#
# By default, we use the "prod" configuration:
if System.get_env("PHX_SERVER") do
  config :fraud_system, FraudSystemWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :fraud_system, FraudSystemWeb.Endpoint,
    ...
    check_origin: false # Allow all origins for WebSocket in this setup

  # Configure Kafka from environment if available
